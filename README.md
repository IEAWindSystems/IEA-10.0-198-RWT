...
The documentation of the turbine and the design process is accessible here: https://www.nlr.gov/docs/fy19osti/73492.pdf
...
If you use the wind turbine, please cite it like this:
    ...
    Url ={https://www.nlr.gov/docs/fy19osti/73492.pdf},
	Year = {2019}}
...
For questions not answered here, please ask to Pietro Bortolotti (pietro.bortolotti@nlr.gov)